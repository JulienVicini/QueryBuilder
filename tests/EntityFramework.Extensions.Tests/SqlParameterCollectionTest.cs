...
//            var param1Name = queryBuilder.AppendParameterValue( 1        );//, SqlDbType.Int      ); 
//            var param2Name = queryBuilder.AppendParameterValue( "sdsqsd" );//, SqlDbType.NVarChar );
//            var param3Name = queryBuilder.AppendParameterValue( true     );//, SqlDbType.Bit      ); 
//            var param4Name = queryBuilder.AppendParameterValue( 1m       );//, SqlDbType.Decimal  );
